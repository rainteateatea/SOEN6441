...
public class DeleteImage {
    ...
    private static ArrayList<BufferedImage> getImagesArrayList() throws Exception {
        ...
        images.add(resize(ImageIO.read(new File(System.getProperty("user.dir")+"\\resource\\tower.png")),100,100));
        images.add(resize(ImageIO.read(new File(System.getProperty("user.dir")+"\\resource\\critter.png")),100,100));
        return images;
    }
