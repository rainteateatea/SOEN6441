...
public class TestCardView6 {
	 ...
	 *             if diameter not in given range.
	 */
	...
	/**
	 * This method tests receive function. Test case: "1": i-i-i-c-a-i-c-a
	 */
	@Test
	...
	// cardView.calculate();
	// assertEquals(cardView.OK.get(), true);
	// }

	/**
	 * This method tests is same function. Test case: i-i-i
	 */
	@Test
	...
	/**
	 * This method tests is different function. Test case: i-c-a
	 */
	@Test
	...
	/**
	 * This method tests is delete function. Test case: boxes: i-i-i card:
	 * i-i-i-c-a-i-c-a
	 */
	@Test
