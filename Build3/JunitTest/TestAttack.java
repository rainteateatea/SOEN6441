...
public class TestAttack {
	...
	public void setUp() throws Exception {
		...
		phase.setCountries(countries);
		phase.setContinents(continents);
		phase.setPlayerSet(playerSet);
		this.backEnd = new BackEnd(phase);
...
//		the number of armies of attacker is more than 3; the number of armies of defender is more than 2;
	...
	@Test
	public void TestWin() {
//		player1 captures country4 which belongs player4
		...
		assertEquals(attack.findPlayer(String.valueOf(country2.getName())), attack.findPlayer(String.valueOf(country4.getName())));
